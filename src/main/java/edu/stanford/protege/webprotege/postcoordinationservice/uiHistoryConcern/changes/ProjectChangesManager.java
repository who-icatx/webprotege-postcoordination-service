...
public class ProjectChangesManager {
    ...
    private List<DiffElement<String, String>> renderDiffElements(List<DiffElement<CustomScaleDocumentChange, PostCoordinationCustomScalesValueEvent>> diffElements, List<EntityNode> renderedEntities) {
